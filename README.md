...
This HACS integration acts as a bridge between **Home Assistant** and the **Z-Station** application.  
It generates structured JSON outputs for API requests used by Z-Station.

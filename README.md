...
Cette intégration HACS sert de pont entre **Home Assistant** et l’application **Z-Station**.  
Elle génère des JSON structurés pour des requêtes API par Z-Station.

---

## 📦 Installation via HACS

### 1️⃣ Ajouter le dépôt dans HACS
